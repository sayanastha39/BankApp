...
public class QueryUtil {
	...
	public static final String DEPOSIT_SQL = "update account_balance_tbl set deposit_amount=? where account_info_id=?";
	public static final String WITHDRAWAL_SQL = "update account_balance_tbl set withdraw_amount=?, balance=?  where account_info_id=?";
}
